...
<body class="mystic">
<div id="pasekL">
<img class="banner" src="./Images/mystic-slim.png" alt="Team Instinct">
</div>
<div id="pasekR">
<img class="banner" src="./Images/mystic-slim.png" alt="Team Instinct">
</div>

<h1 class="mystic">Team Mystic</h1>
...
<div class="leader">
    <figure>
    <img class="leader" src="./Images/Blanche.png" alt="Blanche">
    <figcaption class="mystic">Leader Blanche</figcaption>
    </figure>
</div>
